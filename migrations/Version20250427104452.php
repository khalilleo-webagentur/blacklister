 ...
 */
final class Version20250427104452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE `BL_api_key` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, version VARCHAR(50) NOT NULL, user_agent VARCHAR(150) NOT NULL, api_key VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_991B9C71A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE `BL_black_list` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, api_key_id INT DEFAULT NULL, username VARCHAR(200) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, domain VARCHAR(255) DEFAULT NULL, ip_address VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, count_username_blocked INT NOT NULL, count_email_blocked INT NOT NULL, count_ip_address_blocked INT NOT NULL, count_domain_blocked INT NOT NULL, count_url_blocked INT NOT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_782C61D6A76ED395 (user_id), INDEX IDX_782C61D68BE312B3 (api_key_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
